          ...
          <table class="w-full text-sm sm:text-base">
            ...
            <tbody>
              ${days.map((day, index) => {
                ...
                return `
                  <tr class="${rowClass} hover:bg-red-50 transition-colors border-b border-gray-200">
                    ...
                    <td class="px-3 sm:px-10 py-4 sm:py-8">
                      ${isCompleted 
                        ? `<a href="./views/day${day}/index.html" class="text-blue-600 hover:text-blue-800 font-semibold underline transition-colors text-sm sm:text-base">View Solution</a>`
                        : `<span class="text-gray-500 text-sm sm:text-base">Puzzle locked</span>`
                      }
                    </td>
                    <td class="px-3 sm:px-10 py-4 sm:py-8 text-center">
                      ${isCompleted 
                        ? '<span class="inline-flex items-center px-3 sm:px-4 py-1 sm:py-2 rounded-full bg-green-100 text-green-800 font-semibold text-xs sm:text-sm"><span class="mr-1 sm:mr-2">✓</span>Completed</span>'
                        : '<span class="inline-flex items-center px-3 sm:px-4 py-1 sm:py-2 rounded-full bg-yellow-100 text-yellow-800 font-semibold text-xs sm:text-sm">Coming Soon</span>'
                      }
                    </td>
                  </tr>
                `;
